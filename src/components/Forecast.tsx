    ...
    <div className={cn(
      ...
      {loading ? (
        ...
        <>
          ...
          <span className="text-xs text-gray-500 mb-2">{condition}</span>
          <span className="text-xs text-weather-blue-dark">{precipitation}% rain</span>
        </>
      )}
    </div>
  );
...
const Forecast: React.FC<ForecastProps> = ({ loading = false }) => {
  ...
  const forecastData = [
    { day: 'MON', temperature: 22, condition: 'Sunny', precipitation: 0 },
    { day: 'TUE', temperature: 24, condition: 'Partly Cloudy', precipitation: 10 },
    { day: 'WED', temperature: 21, condition: 'Rainy', precipitation: 60 },
    { day: 'THU', temperature: 19, condition: 'Cloudy', precipitation: 30 },
    { day: 'FRI', temperature: 20, condition: 'Partly Cloudy', precipitation: 20 },
    { day: 'SAT', temperature: 23, condition: 'Sunny', precipitation: 5 },
    { day: 'SUN', temperature: 25, condition: 'Sunny', precipitation: 0 },
  ];
